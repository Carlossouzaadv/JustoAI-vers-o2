...
interface ProcessSummaryData {
  ...
  tags?: string[];
  notes?: string;
  isAutoGeneratedDescription?: boolean; // Indica se descrição foi auto-gerada
}
...
export function ProcessSummary({ processId }: ProcessSummaryProps) {
  ...
  const regenerateDescription = async () => {
    ...
    try {
      ...
      // Atualizar descrição com o novo resumo
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  className="text-xs"
                >
                  {regeneratingDescription ? `${ICONS.LOADING} Gerando...` : '🔄 Regenerar'}
                </Button>
              </div>
              <Textarea
